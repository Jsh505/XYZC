...
- (NSArray *)viewControllers {
    ...
    ArticleVC *secondViewController = [[ArticleVC alloc] init];
    UINavigationController *secondNavigationController = [[CYLBaseNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    HighlightsVC *thirdViewController = [[HighlightsVC alloc] init];
    UINavigationController *thirdNavigationController = [[CYLBaseNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    MyVC *fourthViewController = [[UIStoryboard storyboardWithName:@"MyVC" bundle:nil] instantiateViewControllerWithIdentifier:@"MyVC"];
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemImage : @"首页_未选",  /* NSString and UIImage are supported*/
                                                 CYLTabBarItemSelectedImage : @"首页_已选", /* NSString and UIImage are supported*/
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"文章",
                                                  CYLTabBarItemImage : @"文章_未选",
                                                  CYLTabBarItemSelectedImage : @"文章_已选",
                                                  };
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : @"活动",
                                                 CYLTabBarItemImage : @"活动_未选",
                                                 CYLTabBarItemSelectedImage : @"活动_已选",
                                                 };
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"我的",
                                                  CYLTabBarItemImage : @"我的_未选",
                                                  CYLTabBarItemSelectedImage : @"我的_已选"
                                                  };

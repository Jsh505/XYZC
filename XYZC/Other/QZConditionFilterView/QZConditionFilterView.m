...
{
    QZConditionFilterView *conditionFilter = [[QZConditionFilterView alloc] initWithFrame:CGRectMake(0, 10, SCREEN_WIDTH * 3 / 4, 40)];
...
- (void)createSubView
{
    ...
    _dataSource1Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(0, 0, ((SCREEN_WIDTH * 3 / 4) -1)/3, 40)];
...
//    middleLine.backgroundColor=UIColorFromRGB(0xe6e6e6);
    ...
    _dataSource2Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(_dataSource1Btn.x+_dataSource1Btn.width+0.5, 0, (SCREEN_WIDTH * 3 / 4-1)/3, 40)];
...
//    middleLine2.backgroundColor=UIColorFromRGB(0xe6e6e6);
    ...
    _dataSource3Btn = [self buttonWithLeftTitle:@"" titleColor:UIColorFromRGB(0x333333) Font:[UIFont systemFontOfSize:13] backgroundColor:[UIColor whiteColor] RightImageName:@"PR_filter_choice" Frame:CGRectMake(_dataSource2Btn.x+_dataSource2Btn.width+0.5, 0, (SCREEN_WIDTH * 3 / 4-1)/3, 40)];
...
- (void)resDelegate
{
    if ([self.delegate respondsToSelector:@selector(typeButtonCilick)])
    {
        [self.delegate typeButtonCilick];
    }
}
...
- (void)prepareUIWithBtn:(UIButton *)btn
{
    ...
    if (btn == _dataSource1Btn) {
        _filterTableView1 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom + JSH_NavbarAndStatusBarHeight, SCREEN_WIDTH, 0)];
        ...
        _filterTableView2 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom + JSH_NavbarAndStatusBarHeight, SCREEN_WIDTH, 0)];
        ...
        _filterTableView3 = [[QZFilterDataTableView alloc] initWithFrame:CGRectMake(0, self.bottom + JSH_NavbarAndStatusBarHeight, SCREEN_WIDTH, 0)];
...
{
    if (_bgView)  return;
    _bgView = [[UIView alloc] initWithFrame:CGRectMake(0, JSH_NavbarAndStatusBarHeight+self.y+self.height, SCREEN_WIDTH, SCREEN_HEIGHT-(self.y + self.height))];
...
{
    btn.width=(SCREEN_WIDTH * 3 / 4-1)/3;
    CGSize titleSize = [title sizeWithAttributes:@{NSFontAttributeName:font}];
    UIImage *image = [UIImage imageNamed:imageName];
    CGFloat space = 5;

...
-(void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation{
    ...
    // 获取加载网页的标题
    self.customNavBar.title = self.wkWebView.title;
...
- (WKWebView *)wkWebView{
    if (!_wkWebView) {
        ...
        _wkWebView = [[WKWebView alloc] initWithFrame:CGRectMake(0, JSH_NavbarAndStatusBarHeight, SCREEN_WIDTH, SCREEN_HEIGHT - JSH_NavbarAndStatusBarHeight) configuration:Configuration];

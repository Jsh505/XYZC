...
- (void)setChatToolbar:(EaseChatToolbar *)chatToolbar
{
    ...
    tableFrame.origin.y = JSH_NavbarAndStatusBarHeight;
    tableFrame.size.height = self.view.frame.size.height - _chatToolbar.frame.size.height - iPhoneX_BOTTOM_HEIGHT - JSH_NavbarAndStatusBarHeight;

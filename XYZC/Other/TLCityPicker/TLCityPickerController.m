...
- (void)viewDidLoad {
    ...
    UIBarButtonItem *cancelBarButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"返回"] style:UIBarButtonItemStylePlain target:self action:@selector(cancelButtonDown:)];

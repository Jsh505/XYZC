...
- (instancetype)initWithTitles:(NSArray <NSString *> *)titles {
    ...
    if (self) {
        ...
        _attributesNormal = @{NSFontAttributeName: [UIFont systemFontOfSize:15 weight:UIFontWeightLight],
                              NSForegroundColorAttributeName: [UIColor blackColor]};
        _attributesSelected = @{NSFontAttributeName: [UIFont systemFontOfSize:15 weight:UIFontWeightLight],
                                NSForegroundColorAttributeName: [UIColor blackColor]};
